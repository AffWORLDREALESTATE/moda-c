        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-light font-serif text-gray-800 leading-tight mb-3 sm:mb-4 px-2">
              Follow Our <span className="text-[#DC2626] font-normal">Journey</span>
            </h2>
          ...
          <div className="relative">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl border border-[#DC2626]/20 shadow-2xl p-4 sm:p-6 md:p-8">
              ...
              <div className="text-center mt-6 sm:mt-8">
                <a
                  ...
                  className="inline-flex items-center gap-2 sm:gap-3 bg-gradient-to-r from-[#DC2626] to-[#B91C1C] hover:from-[#B91C1C] hover:to-[#991B1B] text-white px-4 sm:px-6 md:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl font-light tracking-wider transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-sm sm:text-base"
                >
          ...
          <div className="mt-8 sm:mt-12 text-center">
            <p className="text-xs sm:text-sm text-gray-500 font-light mb-4 sm:mb-6 px-2">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="text-[#DC2626] hover:text-[#B91C1C] transition-colors duration-300 ml-1"
              >
