  ...
  return (
    <div className="fixed bottom-7 sm:bottom-10 md:bottom-16 lg:bottom-24 right-6 z-50">
      ...
      >
        ...
        {/* Hover Tooltip */}
        {isHovered && (
          <div className="absolute right-full mr-3 whitespace-nowrap bg-gray-900 text-white text-sm px-4 py-2 rounded-lg shadow-lg">
            {t('whatsapp.chatWithUs') || 'Chat with us'}
